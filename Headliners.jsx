...
function evalCouncilObjective(obj, pd, isTrending) {
  ...
  switch (obj.id) {
    case "ticket_evaders": case "toxic_waste": case "put_a_lid": case "local_breweries": case "number_one_fans": case "thieves_night": r.tickets = count; break;
    ...
    case "special_sauce": r.tickets = count; break;
    case "glamping": r.tickets = count * 2; break;
    case "luxury_loos": r.tickets = count * 2; break;
    ...
    case "meat_the_law": r.vp = count * 2; break;
    ...
    case "show_of_power": r.tickets = count; break;
