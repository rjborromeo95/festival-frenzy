...
const ALL_COUNCIL_OBJECTIVES = [
  { id: "ticket_evaders", name: "Ticket Evaders", flavour: "The council are worried about people sneaking in.", req: "Security on the 2 outermost layers", benefit: "+2 tickets/security on edge, +2 VP if you move security to edge", tBenefit: "+1 Fame/security on edge" },
  { id: "toxic_waste", name: "Toxic Waste", flavour: "Locals are worried about strange smells.", req: "No portaloos on outside edge", benefit: "+2 tickets/portaloo not on edge, +2 VP if you move portaloo to edge", tBenefit: "+1 Fame/portaloo not on edge" },
  { id: "put_a_lid", name: "Put a Lid on it", flavour: "Campers don't want to live next to a toilet.", req: "1 tile gap between portaloos and campsites", benefit: "+2 tickets/campsite not next to portaloo", tBenefit: "+1 Fame/campsite not next to portaloo" },
  { id: "crowd_control", name: "Crowd Control", flavour: "People won't come if they don't feel safe.", req: "Security beside stage", benefit: "+3 tickets/2 security next to stage", tBenefit: "+1 Fame/3 security next to stage" },
  { id: "food_courts", name: "Food Courts", flavour: "Showcase local specialties.", req: "Group 3 catering vans together", benefit: "+3 tickets/3 catering", tBenefit: "+1 Fame/3 catering" },
  { id: "local_breweries", name: "Local Breweries", flavour: "Attract local breweries.", req: "Catering van next to stage", benefit: "+2 tickets/catering next to stage", tBenefit: "+1 Fame/catering next to stage" },
  { id: "groovin_circles", name: "Groovin' Circles", flavour: "The dance area will be cramped.", req: "Keep all tiles beside stage empty", benefit: "+3 tickets/qualifying stage", tBenefit: "+1 Fame/qualifying stage" },
  { id: "sniffer_dogs", name: "Sniffer Dogs", flavour: "Stamp down on illegal substances.", req: "2 security beside each other", benefit: "+2 tickets/security pair", tBenefit: "+1 Fame/security adj to security" },
  { id: "special_sauce", name: "Special Sauce", flavour: "Keep herbs and spices secret.", req: "Security and catering next to each other", benefit: "+2 tickets/security-catering pair", tBenefit: "+1 Fame/security adj to catering" },
  { id: "in_n_out", name: "In-N-Out", flavour: "Strategic food and toilets.", req: "Portaloos and catering next to each other", benefit: "+3 tickets/portaloo adj to catering", tBenefit: "+1 Fame/portaloo adj to catering" },
  { id: "quiet_camping", name: "Quiet Camping", flavour: "Campers should sleep well.", req: "Campsite at least 3 tiles from stage", benefit: "+3 tickets/campsite 3+ from stage", tBenefit: "+1 Fame/campsite 3+ from stage" },
  { id: "glamping", name: "Glamping", flavour: "Exclusive camping areas.", req: "Campsite, security and portaloo clustered together", benefit: "+3 tickets/campsite-security-portaloo cluster", tBenefit: "+1 Fame/campsite adj to security" },
  { id: "luxury_loos", name: "Luxury Loos", flavour: "The council like 2 ply toilet roll.", req: "Security in between 2 portaloos", benefit: "+3 tickets/portaloo-security-portaloo cluster", tBenefit: "+1 Fame/portaloo adj to security" },
  { id: "number_one_fans", name: "Number One Fans", flavour: "More portaloos near stages.", req: "Portaloos beside stages", benefit: "+2 tickets/portaloo beside stage", tBenefit: "+1 Fame/3 portaloos" },
  { id: "form_a_line", name: "Form a Line", flavour: "The council want an orderly food area.", req: "Catering vans in a straight line (min 2)", benefit: "+2 tickets per catering in line", tBenefit: "+1 Fame if 2+ catering in a line" },
  { id: "noise_complaints", name: "Noise Complaints", flavour: "Concern from neighbours.", req: "Move amenities nearer to centre", benefit: "+3 tickets and +3 VP per amenity moved inward", tBenefit: "+1 Fame/2 amenities not on edge" },
  { id: "multiple_entrances", name: "Multiple Entrances", flavour: "Crowd calming measures.", req: "Security at stage + security at edge in line", benefit: "+4 tickets per qualifying pair", tBenefit: "+1 Fame per qualifying pair" },
  { id: "reheating_fish", name: "Reheating Fish", flavour: "Campers might complain about food stalls.", req: "Campsites 3+ tiles from catering", benefit: "+3 tickets/campsite 3+ from catering", tBenefit: "+1 Fame/campsite 3+ from catering" },
  { id: "eat_local", name: "Eat Local", flavour: "Food close to camp.", req: "Catering and campsite next to each other", benefit: "+2 tickets/campsite adj to catering", tBenefit: "+1 Fame/campsite adj to catering" },
  { id: "thieves_night", name: "Thieves in the Night", flavour: "Worried about thieves.", req: "Campsites within 2 tiles of security", benefit: "+2 tickets/campsite within 2 tiles of security", tBenefit: "+1 Fame/3 security" },
  { id: "meat_the_law", name: "Meat the Law", flavour: "Look after the catering vans.", req: "Catering vans within 2 tiles of security", benefit: "+2 tickets/protected catering van", tBenefit: "+1 Fame/3 security" },
  { id: "orderly_queues", name: "Orderly Queues", flavour: "Order around the catering vans.", req: "Security + catering in line with 2 empty tiles", benefit: "+2 tickets per qualifying pair", tBenefit: "+1 Fame per qualifying pair" },
  ...
  { id: "chef_beef", name: "Chef Beef", flavour: "Rival food vendors want their own space.", req: "Catering 5+ tiles from another catering", benefit: "+2 tickets/isolated catering", tBenefit: "" },
  ...
  { id: "keep_the_peace", name: "Keep the Peace", flavour: "Spacing out campers keeps everyone happy.", req: "2+ campsites with 1 empty tile gap", benefit: "+2 tickets/spaced campsite pair", tBenefit: "" },
];

const ALL_EVENTS = [
  // Positive events
  { name: "Album Release", color: "green", desc: "A random artist has released an album.", cond: "played_artist", result: "+1 Fame", apply: () => ({ fame: 1 }) },
  { name: "Food Glorious Food", color: "green", desc: "People really love the food!", cond: "has_catering", result: "+1 Fame", apply: () => ({ fame: 1 }) },
  ...
  { name: "Sunny Weekend", color: "green", desc: "The good weather brings more sales.", cond: null, result: "+5 tickets", apply: () => ({ tickets: 5 }) },
  { name: "Trending Artist", color: "green", desc: "One of your headliners is surprisingly popular.", cond: "has_headliner", result: "+1 Fame", apply: () => ({ fame: 1 }) },
  ...
  { name: "Sanitation Nation", color: "green", desc: "People loved the new toilets.", cond: "has_portaloo", result: "+1 Fame", apply: () => ({ fame: 1 }) },
  ...
  { name: "Hired Muscle", color: "green", desc: "Your new security showed professionalism.", cond: "has_security", result: "+1 Fame", apply: () => ({ fame: 1 }) },
  { name: "Fully Erect", color: "green", desc: "Your new campsites were popular.", cond: "has_campsite", result: "+1 Fame", apply: () => ({ fame: 1 }) },
  { name: "Bartenders with Flair", color: "green", desc: "Your catering vans juggle cocktail shakers.", cond: "catering_near_stage", result: "+1 VP", apply: () => ({ vp: 1 }) },
  ...
  { name: "Passed Out", color: "red", desc: "Someone fainted in the crowd.", cond: "less_than_4_security", result: "-1 ticket", avoidable: true, apply: () => ({ tickets: -1 }) },
  { name: "Dehydration", color: "red", desc: "Long water queues.", cond: null, result: "-1 Fame (or -2 if Fame 4+)", avoidable: true, apply: (pd) => ({ fame: (pd.fame||0) >= 4 ? -2 : -1 }) },
  ...
  { name: "Supply Issues", color: "red", desc: "Some catering vans ran out of stock.", cond: "has_catering", result: "Lose half catering (rounded down)", avoidable: true, apply: (pd) => { const n = Math.floor((pd.amenities||[]).filter(a=>a.type==="catering").length / 2); return { removeAmenityCount: { type: "catering", count: n } }; } },
  { name: "Long Queues", color: "red", desc: "Demand was too high for catering.", cond: "catering_lt_stages", result: "-5 tickets if less catering than stages", avoidable: true, apply: () => ({ tickets: -5 }) },
  { name: "If You Gotta Go...", color: "red", desc: "Demand was too high for portaloos.", cond: "portaloo_overloaded", result: "Lose 1 portaloo if <10 tickets per portaloo", avoidable: true, apply: () => ({ removeAmenity: "portaloo" }) },
];
...
function evalCouncilObjective(obj, pd, isTrending) {
  ...
  switch (obj.id) {
    ...
    case "glamping": { const gc = ofType("campsite"); const gs = ofType("security"); const gp = ofType("portaloo"); const usedC = new Set(); const usedS = new Set(); const usedP = new Set(); for (const c of gc) { if (usedC.has(`${c.col},${c.row}`)) continue; for (const s of gs) { if (usedS.has(`${s.col},${s.row}`)) continue; if (!areAdjacent(c.col,c.row,s.col,s.row)) continue; for (const p of gp) { if (usedP.has(`${p.col},${p.row}`)) continue; if (areAdjacent(p.col,p.row,c.col,c.row) || areAdjacent(p.col,p.row,s.col,s.row)) { count++; usedC.add(`${c.col},${c.row}`); usedS.add(`${s.col},${s.row}`); usedP.add(`${p.col},${p.row}`); break; } } if (usedC.has(`${c.col},${c.row}`)) break; } } break; }
    case "luxury_loos": { const lSec = ofType("security"); const lPor = ofType("portaloo"); const usedSec = new Set(); for (const s of lSec) { if (usedSec.has(`${s.col},${s.row}`)) continue; const adjP = lPor.filter(p => areAdjacent(p.col, p.row, s.col, s.row)); if (adjP.length >= 2) { count++; usedSec.add(`${s.col},${s.row}`); } } break; }
    ...
    case "noise_complaints": count = Math.floor(am.filter(a => !isEdgeHex(a.col, a.row)).length / 2); break; // Trending uses this; move bonus tracked separately
    ...
    case "thieves_night": { const tSec = ofType("security"); count = ofType("campsite").filter(c => tSec.some(s => hexDistance(c.col, c.row, s.col, s.row) <= 2)).length; break; }
    case "meat_the_law": { const mSec = ofType("security"); count = ofType("catering").filter(c => mSec.some(s => hexDistance(c.col, c.row, s.col, s.row) <= 2)).length; break; }
  ...
  const bid = obj.id;
  if (bid === "ticket_evaders" || bid === "toxic_waste" || bid === "put_a_lid" || bid === "local_breweries" || bid === "number_one_fans" || bid === "thieves_night") r.tickets = count * 2;
  else if (bid === "crowd_control") r.tickets = Math.floor(count / 2) * 3;
  else if (bid === "food_courts") r.tickets = count * 3;
  else if (bid === "groovin_circles") r.tickets = count * 3;
  else if (bid === "sniffer_dogs") r.tickets = count * 2;
  else if (bid === "special_sauce") r.tickets = count * 2;
  else if (bid === "glamping") r.tickets = count * 3;
  else if (bid === "luxury_loos") r.tickets = count * 3;
  else if (bid === "in_n_out") r.tickets = count * 3;
  else if (bid === "quiet_camping") r.tickets = count * 3;
  else if (bid === "form_a_line") r.tickets = count >= 2 ? count * 2 : 0;
  else if (bid === "noise_complaints") r.tickets = count * 3;
  else if (bid === "multiple_entrances") r.tickets = count * 4;
  else if (bid === "reheating_fish") r.tickets = count * 3;
  else if (bid === "eat_local") r.tickets = count * 2;
  else if (bid === "meat_the_law") r.tickets = count * 2;
  else if (bid === "orderly_queues") r.tickets = count * 2;
  else if (bid === "sit_downs") r.tickets = count * 3;
  else if (bid === "yours_or_mine") r.tickets = count * 4;
  else if (bid === "chef_beef") r.tickets = count * 2;
  else if (bid === "show_of_power") r.tickets = count * 2;
  else if (bid === "keep_the_peace") r.tickets = count * 2;
  return r;
}
...
export default function Headliners() {
  ...
  const recalcTickets = useCallback(() => {
    setPlayerData(prev => {
      ...
      for (const pid of Object.keys(next)) {
        ...
        // Compute fame directly (not via closure)
        let fame = pd.baseFame || 0;
        if (trendingCouncil) {
          const tb = evalCouncilObjective(trendingCouncil, pd, true);
          if (tb.active && tb.fame > 0) fame += tb.fame;
        }
        // Ticket-based fame: +1 Fame per 20 tickets (does NOT affect goal tracking)
        fame += Math.floor(t / 20);
  ...
  function refreshPool(cycles = 1) {
    ...
    for (let cycle = 0; cycle < cycles; cycle++) {
      // Move current pool to discard for next cycle
      if (cycle > 0) { disc = [...disc, ...pool]; pool.forEach(a => inUse.delete(a.name)); pool = []; }
      while (pool.length < 5) {
        if (deck.length === 0 && disc.length > 0) {
          deck = shuffle(disc.filter(a => !inUse.has(a.name)));
          disc = disc.filter(a => inUse.has(a.name));
  ...
  function applyEffect(artist, pid, times = 1, stageIdx = -1) {
    ...
    for (let t = 0; t < times; t++) {
      ...
      if (el.includes("roll 1 amenity dice") || el.includes("roll 1 amenity die")) {
        triggerDiceRoll(1, pid, artist.name, "+1 Fame per Fame shown",
          (results) => { const fameCount = results.filter(d => d === "fame").length; if (fameCount > 0) { setPlayerData(p => ({ ...p, [pid]: { ...p[pid], baseFame: Math.min(FAME_MAX, (p[pid].baseFame || 0) + fameCount) } })); showFloatingBonus(`+${fameCount} 🔥`, "#f97316"); } recalcTickets(); }
        );
      }
      // === Ticket effects ===
    ...
    let rollMatch = el.match(/roll (\d+) dice/);
    ...
    if (rollMatch) {
      ...
      if (el.includes("each fame") && el.includes("ticket")) {
        triggerDiceRoll(rollCount, pid, artist.name,
          ...
          (results) => { const fameCount = results.filter(d => d === "fame").length; if (fameCount > 0) { setPlayerData(p => ({ ...p, [pid]: { ...p[pid], bonusTickets: (p[pid].bonusTickets || 0) + fameCount * 2 } })); showFloatingBonus(`+${fameCount * 2} 🎟️`, "#fbbf24"); } recalcTickets(); }
        );
  ...
  const aiStep = () => {
    ...
    if (phase === "preRound") {
      if (preRoundStep === "notify") {
        ...
        else { startFreeAmenities(); scheduleNext(400); }
        return;
      }
      ...
      if (preRoundStep === "freeAmenityChoose") {
        // AI picks the amenity type it has least of
        const pd = playerData[currentPreRoundPlayer?.id] || {};
        const counts = { campsite: 0, portaloo: 0, security: 0, catering: 0 };
        (pd.amenities || []).forEach(a => { if (counts[a.type] !== undefined) counts[a.type]++; });
        const best = Object.entries(counts).sort((a, b) => a[1] - b[1])[0][0];
        setFreeAmenityType(best); setPreRoundStep("placeFreeAmenity"); scheduleNext(300); return;
      }
      if (preRoundStep === "placeFreeAmenity") {
        const pd = playerData[currentPreRoundPlayer?.id] || {};
        const pos = aiFindPlacement(pd);
        handlePreRoundHexClick(pos.col, pos.row); scheduleNext(300); return;
      }
  ...
  const handleGameHexClick = (col, row) => {
    ...
    if (turnAction === "pickAmenity" && placingAmenity) {
      ...
      if (!movingFrom) { const am = currentPD.amenities.find(a => a.col === col && a.row === row); if (am) setMovingFrom({ col, row, type: am.type }); }
        ...
        // Council move bonuses
        (playerCouncils[currentPlayerId] || []).forEach(co => {
          if (!co.active) return;
          if (co.obj.id === "ticket_evaders" && movingFrom.type === "security" && isEdgeHex(col, row)) {
            setPlayerData(p => ({ ...p, [currentPlayerId]: { ...p[currentPlayerId], vp: (p[currentPlayerId].vp || 0) + 2 } }));
            addLog(currentPlayer.festivalName, `📋 Ticket Evaders: Moved security to edge → +2 VP!`);
            showFloatingBonus("+2 ⭐", "#c4b5fd");
          }
          if (co.obj.id === "toxic_waste" && movingFrom.type === "portaloo" && !isEdgeHex(col, row) && isEdgeHex(movingFrom.col, movingFrom.row)) {
            setPlayerData(p => ({ ...p, [currentPlayerId]: { ...p[currentPlayerId], vp: (p[currentPlayerId].vp || 0) + 2 } }));
            addLog(currentPlayer.festivalName, `📋 Toxic Waste: Moved portaloo off edge → +2 VP!`);
            showFloatingBonus("+2 ⭐", "#c4b5fd");
          }
          if (co.obj.id === "noise_complaints") {
            const oldDist = hexDistance(movingFrom.col, movingFrom.row, 6, 6);
            const newDist = hexDistance(col, row, 6, 6);
            if (newDist < oldDist) {
              setPlayerData(p => ({ ...p, [currentPlayerId]: { ...p[currentPlayerId], vp: (p[currentPlayerId].vp || 0) + 3, bonusTickets: (p[currentPlayerId].bonusTickets || 0) + 3 } }));
              addLog(currentPlayer.festivalName, `📋 Noise Complaints: Moved amenity inward → +3 VP +3 tickets!`);
              showFloatingBonus("+3 ⭐ +3 🎟️", "#c4b5fd");
            }
          }
        });
  ...
  function applyEventsForPlayer(pid) {
    ...
    const totalCouncils = (playerCouncils[pid] || []).length;
  ...
  const advanceEventPhase = () => {
    ...
    if (eventPhasePlayer < players.length - 1) {
      ...
      // Let event state updates settle, then score
    ...
    for (const p of players) {
      ...
      (pd.stageArtists || []).forEach(sa => sa.forEach(a => {
        try {
          ...
          if (eff.includes("vp / fame gained")) vpBonus += pd.baseFame || 0;
          if (eff.includes("vp if you have the highest fame")) {
            const isHighest = players.every(op => op.id === p.id || computeFame(snap[op.id] || {}, snap[op.id]?.tickets || 0) <= fame);
            if (isHighest) { vpBonus += 1; if (players.every(op => op.id === p.id || (snap[op.id]?.tickets || 0) <= rawT)) vpBonus += 3; }
          }
          ...
          if (eff.includes("vp / 3 amenities")) vpBonus += Math.floor((pd.amenities || []).length / 3);
          if (eff.includes("vp / council objective")) vpBonus += (playerCouncils[p.id] || []).filter(co => { try { return evalCouncilObjective(co.obj, pd, false).count > 0; } catch(e) { return false; } }).length;
          if (eff.includes("roll all") && eff.includes("unique amenity")) vpBonus += new Set(shuffle([...DICE_OPTIONS, ...DICE_OPTIONS]).slice(0, 5)).size;
          if (eff.includes("roll all") && eff.includes("most common")) { const r = shuffle([...DICE_OPTIONS, ...DICE_OPTIONS]).slice(0, 5); const c = {}; r.forEach(d => { c[d]=(c[d]||0)+1; }); vpBonus += Math.max(...Object.values(c)); }
          if (eff.includes("1vp per existing campsite") || eff.includes("1 vp per existing campsite")) vpBonus += (pd.amenities || []).filter(am => am.type === "campsite").length;
          // Year End: -X VP. Sell Y tickets (Kendrick)
          { const yearEndVpLoss = (a.effect || "").match(/Year End:.*-(\d+)\s*VP/i);
            if (yearEndVpLoss) vpBonus -= parseInt(yearEndVpLoss[1]);
          }
          { const yearEndSell = (a.effect || "").match(/Year End:.*[Ss]ell\s+(\d+)\s+tickets?/i);
            if (yearEndSell) rawT += parseInt(yearEndSell[1]);
          }
          // Year End: +1 VP / Hip Hop artist you've played this Year (Eminem)
          if (eff.includes("vp / hip hop artist")) {
      ...
      logs.push({ type: "entry", who: p.festivalName, text: `🎟️ ${rawT}→${ticketVP}VP | 🔥${fame}→${fameVP}VP | Artists+${artistVP}VP` });
      // Store computed values back into snap for use by subsequent players (Lady Gaga comparison)
      snap[p.id] = { ...pd, tickets: rawT, rawTickets: rawT, fame, vp: (pd.vp || 0) + vpBonus };
    }
  ...
  const getFreeAmenityCount = (pd) => {
    const stageCount = (pd?.stages || []).length;
    if (stageCount >= 3) return 2;
    if (stageCount >= 2) return 1;
    return 0;
  };

  const startFreeAmenities = (overrideStageCount) => {
    const pd = playerData[currentPreRoundPlayer.id];
    const stageCount = overrideStageCount ?? (pd?.stages || []).length;
    const freeCount = stageCount >= 3 ? 2 : stageCount >= 2 ? 1 : 0;
    if (freeCount > 0) {
      setFreeAmenityCount(freeCount); setFreeAmenityPlaced(0); setFreeAmenityType(null);
      setPreRoundStep("freeAmenityChoose");
    } else {
      nextPreRound();
    }
  };
  ...
  const handlePreRoundHexClick = (col, row) => {
    ...
    } else if (preRoundStep === "placeFreeAmenity") {
      if (!freeAmenityType) return;
      const freshPd = playerData[pid]; // re-read for current amenities
      if (isOnStage(col, row, freshPd.stages) || freshPd.amenities.some(a => a.col === col && a.row === row)) return;
      setPlayerData(p => ({ ...p, [pid]: { ...p[pid], amenities: [...p[pid].amenities, { col, row, type: freeAmenityType }] } }));
      addLog(currentPreRoundPlayer.festivalName, `placed free ${AMENITY_LABELS[freeAmenityType]}`);
      showFloatingBonus(`+${AMENITY_ICONS[freeAmenityType]}`, "#4ade80"); sfx.placeAmenity();
      const newPlaced = freeAmenityPlaced + 1;
      setFreeAmenityPlaced(newPlaced); setFreeAmenityType(null);
      if (newPlaced < freeAmenityCount) {
        setPreRoundStep("freeAmenityChoose"); // pick next type
      } else {
        nextPreRound();
      }
    }
  ...
  const confirmPreRoundStage = () => {
    ...
    startFreeAmenities(currentStages);
  };
  ...
  const updateNotesModal = showUpdateNotes ? <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.8)", zIndex: 1100, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={() => setShowUpdateNotes(false)}>
    <div style={{ background: "#0f0e1a", border: "1px solid #22c55e", borderRadius: 16, padding: 24, maxWidth: 600, maxHeight: "80vh", overflowY: "auto", width: "100%" }} onClick={e => e.stopPropagation()}>
      ...
      <div style={{ color: "#e9d5ff", fontSize: 12, lineHeight: 1.8 }}>
        ...
        <p>• <strong style={{ color: "#4ade80" }}>Free Amenities</strong> — Between years, players with 2 stages place 1 free amenity, players with 3 stages place 2. Choose the type and place on your board.</p>
          ...
          {sidebarTab === "goals" && <>
            {activeGoals.map((ag, gi) => {
              ...
              return <div key={gi} style={{ marginTop: 8, padding: 10, borderRadius: 10, background: "rgba(251,191,36,0.06)", border: "1px solid rgba(251,191,36,0.2)" }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: "#fbbf24", marginBottom: 4 }}>🏆 {g.name} <span style={{ fontSize: 9, color: "#94a3b8", fontWeight: 400 }}>({ag.rewardType === "artist" ? "Artist Prize" : "VP Race"})</span></div>
                <div style={{ fontSize: 10, color: done ? "#4ade80" : "#c4b5fd", marginBottom: 4 }}>{done ? "✅" : "🎯"} {g.desc} ({myProgress}/{g.target})</div>
                {ag.rewardType === "artist" && ag.setAsideArtists[0] && <div style={{ fontSize: 9, color: "#94a3b8", marginBottom: 4 }}>Prize: <strong style={{ color: "#e9d5ff" }}>{ag.setAsideArtists[0].name}</strong> (★{ag.setAsideArtists[0].fame} — plays free) {ag.claimedBy1st !== null && <span style={{ color: "#4ade80" }}>→ Won by {players.find(p => p.id === ag.claimedBy1st)?.festivalName}</span>}</div>}
                {ag.rewardType === "vp" && <div style={{ fontSize: 9, color: "#94a3b8", marginBottom: 4 }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: 16, overflow: "auto" }}>
          ...
          <div style={{ ...card, width: "100%", maxWidth: 700, marginTop: 12, padding: 16, alignSelf: "center" }}>
            ...
            {!actionTaken && turnAction === "buyCouncil" && councilChoiceOptions && <div style={{ textAlign: "center" }}>
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                {councilChoiceOptions.map((obj, ci) => <div key={ci} onClick={() => {
                  ...
                  setPlayerCouncils(prev => ({ ...prev, [currentPlayerId]: [...(prev[currentPlayerId] || []), { obj: picked, active: true }] }));
            ...
            {!actionTaken && turnAction === "artist" && artistAction === "bookPool" && !selectedArtist && <div style={{ textAlign: "center" }}>
              ...
              {(currentPD.amenities || []).some(a => a.type === "portaloo") && <button onClick={() => setArtistAction("spendPortaloo")} style={{ ...bs, fontSize: 11, marginBottom: 10, background: "rgba(96,165,250,0.15)", border: "1px solid #60a5fa", color: "#60a5fa" }}>🚽 Spend a Portaloo to refresh the pool ×2</button>}
              <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            {!actionTaken && turnAction === "artist" && artistAction === "spendPortaloo" && <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#94a3b8", fontSize: 11, marginBottom: 12 }}>Click a portaloo on the hex grid to remove it and refresh the artist pool twice.</p>
              <HexGrid stages={currentPD.stages || []} amenities={currentPD.amenities || []} stageColors={currentPD.stageColors || []} onHexClick={(col, row) => {
                ...
                addLog(currentPlayer.festivalName, `Sacrificed 🚽 portaloo at (${col},${row}) to refresh artist pool ×2`);
        ...
        <div style={{ ...card, textAlign: "center", maxWidth: 600, width: "100%" }}>
          ...
          {eventPhaseStep === "results" && evtRes && <>
            <div style={{ marginBottom: 12, padding: 8, borderRadius: 10, background: "rgba(124,58,237,0.1)", fontSize: 12, color: "#94a3b8" }}>
              👮‍♀️ Sacrificed: {securityDelegation} (blocks {securityDelegation * 2}) • 🔴 Total negative: {evtRes.totalNeg} • 🛡️ Blocked: {evtRes.blocked.length}
            </div>
  ...
  if (phase === "preRound") {
    ...
    const freeCount = getFreeAmenityCount(prpd);
    return (<div style={CS}>{logBtn}{showLog && <GameLog log={gameLog} onClose={() => setShowLog(false)} />}
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", padding: 24 }}>
        {preRoundStep === "notify" && prp && <div style={{ ...card, textAlign: "center", maxWidth: 480 }}>
          ...
          {freeCount > 0 && <div style={{ padding: 12, borderRadius: 10, background: "rgba(34,197,94,0.1)", border: "1px solid #22c55e40", marginBottom: 12 }}>
            <p style={{ color: "#4ade80", fontSize: 14, fontWeight: 700, margin: "0 0 4px" }}>🎁 {freeCount} free amenit{freeCount > 1 ? "ies" : "y"} to place!</p>
            <p style={{ color: "#94a3b8", fontSize: 11 }}>{stageCount >= 3 ? "3 stages = 2 free amenities" : "2 stages = 1 free amenity"}</p>
          </div>}
          {!canOpenStage && freeCount === 0 && <p style={{ color: "#64748b", fontSize: 12, marginBottom: 12 }}>No stage to open and no free amenities this round.</p>}
          <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
            ...
            {!canOpenStage && <button onClick={() => startFreeAmenities()} style={bp}>{freeCount > 0 ? "Place Free Amenities →" : "Continue →"}</button>}
          </div>
        </div>}
        ...
        {preRoundStep === "freeAmenityChoose" && prp && <div style={{ ...card, textAlign: "center", maxWidth: 400 }}>
          <h3 style={{ color: "#4ade80", marginBottom: 8 }}>🎁 Free Amenity ({freeAmenityPlaced + 1}/{freeAmenityCount})</h3>
          <p style={{ color: "#94a3b8", fontSize: 12, marginBottom: 16 }}>Choose an amenity type to place for free:</p>
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            {["campsite","portaloo","security","catering"].map(type => <button key={type} onClick={() => { setFreeAmenityType(type); setPreRoundStep("placeFreeAmenity"); }} style={{ ...bs, fontSize: 20, padding: "12px 20px", flexDirection: "column", display: "flex", alignItems: "center", gap: 4 }}>{AMENITY_ICONS[type]}<span style={{ fontSize: 10 }}>{AMENITY_LABELS[type]}</span></button>)}
          </div>
        </div>}
        {preRoundStep === "placeFreeAmenity" && prp && <div style={{ textAlign: "center" }}><div style={{ ...card, display: "inline-block", marginBottom: 12, padding: "10px 20px" }}><p style={{ color: "#4ade80", margin: 0, fontSize: 14 }}>{AMENITY_ICONS[freeAmenityType]} Place your free {AMENITY_LABELS[freeAmenityType]}</p></div><HexGrid stages={playerData[prp.id]?.stages || []} amenities={playerData[prp.id]?.amenities || []} onHexClick={handlePreRoundHexClick} onHexHover={setHoverHex} hoverHex={hoverHex} /></div>}
      </div>{anim}</div>);
  }
