...
function evalCouncilObjective(obj, pd, isTrending) {
  ...
  const bid = obj.id;
  if (bid === "ticket_evaders" || bid === "toxic_waste" || bid === "put_a_lid" || bid === "local_breweries" || bid === "number_one_fans" || bid === "thieves_night") r.tickets = count * 3;
  else if (bid === "crowd_control") r.tickets = Math.floor(count / 2) * 4;
  else if (bid === "food_courts") r.tickets = count * 4;
  else if (bid === "groovin_circles") r.tickets = count * 4;
  else if (bid === "sniffer_dogs") r.tickets = count * 3;
  else if (bid === "special_sauce") r.tickets = count * 3;
  else if (bid === "glamping") r.tickets = count * 4;
  else if (bid === "luxury_loos") r.tickets = count * 4;
  else if (bid === "in_n_out") r.tickets = count * 4;
  else if (bid === "quiet_camping") r.tickets = count * 4;
  else if (bid === "form_a_line") r.tickets = count >= 2 ? count * 3 : 0;
  else if (bid === "noise_complaints") r.tickets = count * 4;
  else if (bid === "multiple_entrances") r.tickets = count * 5;
  else if (bid === "reheating_fish") r.tickets = count * 4;
  else if (bid === "eat_local") r.tickets = count * 3;
  else if (bid === "meat_the_law") r.tickets = count * 3;
  else if (bid === "orderly_queues") r.tickets = count * 3;
  else if (bid === "sit_downs") r.tickets = count * 4;
  else if (bid === "yours_or_mine") r.tickets = count * 5;
  else if (bid === "chef_beef") r.tickets = count * 3;
  else if (bid === "show_of_power") r.tickets = count * 3;
  else if (bid === "keep_the_peace") r.tickets = count * 3;
  return r;
}
  ...
  const recalcTickets = useCallback(() => {
    setPlayerData(prev => {
      ...
      for (const pid of Object.keys(next)) {
        ...
        t += pd.bonusTickets || 0;
        // Council ticket benefits (personal councils — use ref for latest)
        const councils = playerCouncilsRef.current[pid] || [];
        councils.forEach(co => {
          if (co.active) {
        ...
        // Ticket-based fame: +1 Fame per 10 tickets
      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <div style={{ width: 220, padding: 16, borderRight: "1px solid #2a2a4a", overflowY: "auto", flexShrink: 0 }}>
          ...
          {sidebarTab === "trending" && <>
            ...
            {/* Personal events drawn at year end — no global events preview */}
          </>}
