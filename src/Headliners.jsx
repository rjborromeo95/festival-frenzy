...
const ALL_EVENTS = [
  ...
  { name: "TED Talk on Stage", color: "red", desc: "A headliner uses their set for politics.", cond: "has_headliner", result: "-1 Fame", avoidable: true, apply: () => ({ fame: -1 }) },
  { name: "Rowdy Crowd", color: "red", desc: "A fight erupted in the crowd.", cond: null, result: "-1 ticket per act", avoidable: true, apply: (pd) => ({ tickets: -(pd.stageArtists||[]).flat().length }) },
  { name: "Passed Out", color: "red", desc: "Someone fainted in the crowd.", cond: "less_than_4_security", result: "-1 Fame", avoidable: true, apply: () => ({ fame: -1 }) },
  { name: "Agent Fallout", color: "red", desc: "You had an argument with an artist agent.", cond: "has_hand", result: "Lose 1 card from hand", avoidable: true, apply: () => ({ discardHand: 1 }) },
  { name: "Dehydration", color: "red", desc: "Long water queues.", cond: null, result: "-1 Fame", avoidable: true, apply: () => ({ fame: -1 }) },
];
