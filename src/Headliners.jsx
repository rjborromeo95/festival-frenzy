  ...
  const beginRoundEnd = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        } catch(e) { console.error("beginRoundEnd inner error:", e); setPhase("roundEnd"); }
      }, 50);
      } catch(e) { console.error("beginRoundEnd mid error:", e); setPhase("roundEnd"); }
    }, 50);
    } catch(e) { console.error("beginRoundEnd outer error:", e); setPhase("roundEnd"); }
  };
